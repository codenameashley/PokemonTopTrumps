...
## Creating a file for scores
# f = open('PokeScores.txt', 'x')
...
print('A new contender has entered the arena!\n{} from {} is ready to battle!\n'.format(q, r))
...
print('Your opponent for this battle is {} of {}\n'.format(l, m))
...
pokecard6 = pokemoncard()

print('Battle Master: "I see you have brought 6 pokemons with you to battle"\n')
print('You check your bag and see 6 pokeballs')
pokeballs = ('Pokeball 1 contains {},   Pokeball 2 contains {},\n'
             'Pokeball 3 contains {},   Pokeball 4 contains {},\n'
             'Pokeball 5 contains {},   Pokeball 6 contains {},\n').format(pokecard1['name'], pokecard2['name'],
                                                                           pokecard3['name'], pokecard4['name'],
                                                                           pokecard5['name'], pokecard6['name'])
...
chosen_card1 = int(input(
    'Which pokemon would you like to play against {} ? Type 1 for {}, 2 for {}, 3 for {}, 4 for {}, 5 for {}, 6 for {}\n'.format(
        l, pokecard1['name'],
        pokecard2['name'],
        pokecard3['name'],
        pokecard4['name'],
...
def cardforgame1():
    if chosen_card1 == 1:
        ...
        return ('{},\nid {},\nheight {},\nweight {},\nbase experience {}'.format(pokecard6['name'],
                                                                                 pokecard6['id'],
                                                                                 pokecard6['height'],
                                                                                 pokecard6['weight'],
                                                                                 pokecard6['base_xp']))
...
print('\n{} chose to play {}'.format(q, cardforgame1()))
...
def my_card_and_my_stat1():
    ...
    if chosen_card1 == 6:
        if my_stat1 == 'height':
            return pokecard6['height']
    if chosen_card1 == 6:
        if my_stat1 == 'weight':
            return pokecard6['weight']
    if chosen_card1 == 6:
        if my_stat1 == 'base xp':
            return pokecard6['base_xp']
    else:
...
def randomoppcard():
    ...
    if j == 1:
        ...
        return oppcard6['name'], oppcard6['id'], oppcard6['height'], oppcard6['weight'], oppcard6['base_xp']
...
def opponents_card_and_stat1():
    ...
    if k == 6:
        if my_stat1 == 'height':
            return oppcard6['height']
    if k == 6:
        if my_stat1 == 'weight':
            return oppcard6['weight']
    if k == 6:
        if my_stat1 == 'base xp':
            return oppcard6['base_xp']

    else:
        return print('You need to chose a pokemon to battle')
...
print('         **BATTLE STAGE**            \n')
print(
    'Battle Master: "There are 3 rounds in the battle stage, whoever wins 2 rounds will be the battle arena champion!"')
print('{} and {} are ready! Let the battle commence!\n'.format(q, l))
...
pokemoncard()
print('PREPARATION STAGE\n')
print('Your current pokemons are')
print(pokeballs)
chosen_card2 = int(input(
    'Which pokemon would you like to play against {} ? Type 1 for {}, 2 for {}, 3 for {}, 4 for {}, 5 for {}, 6 for Pokemon {}\n'.format(
        l, pokecard1['name'],
        pokecard2['name'],
        pokecard3['name'],
        pokecard4['name'],
...
cardforgame2()
print('\nYou chose to play {}'.format(cardforgame2()))
my_stat2 = input(
    '\nWhich stat would you like to play against {}? Choose between *id, height, weight, base xp*\n'.format(l))
...
def results3():
    ...
    if c > u:
        ...
        print(
            '\nAlright! {} wins round 3! \nYour stat was {}, {}s stat was {} \n{} says: "Theres no way I lost! "'.format(
                q, c, l, u, l))
    if c < u:
        with open('PokeScores.txt', 'a') as myfile:
            myfile.write('Opponent 3' + str(3))
        print(
            '\nYou lose! {} wins round 3! \nYour stat was {}, {}s stat was {}, \n{} says "I knew Id beat you!"'.format(
                l, c, l, u, l))
    elif c == u:
        print('\nAww! Its a draw')
...
print('\n{}s pokemons were {}, {}, {}, {}, {}, {}'.format(l, oppcard1['name'], oppcard2['name'], oppcard3['name'],
                                                           oppcard4['name'], oppcard5['name'], oppcard6['name']))

with open('PokeScores.txt') as myfile:
    for line in myfile:
        if 'Player ' + str(3) in line:
            print(
                '\nAfter 3 intense rounds, we have a winner!\nAnd the battle arena champion is\n {}!!!\n{} says: "Good game {}... You beat me fair and sqaure"'.format(
                    q, l, q))
        elif 'Opponent ' + str(3) in line:
            print(
                '\nAfter 3 intense rounds, the battle arena champion is {}!\nBattle Master: "keep training and dont give up {}, you have a bright future ahead of you"'.format(
                    l, q))
